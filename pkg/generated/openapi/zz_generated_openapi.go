...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/rancher/steve/pkg/ext/testapis/v1.TestType":          schema_pkg_ext_testapis_v1_TestType(ref),
		"github.com/rancher/steve/pkg/ext/testapis/v1.TestTypeList":      schema_pkg_ext_testapis_v1_TestTypeList(ref),
		"github.com/rancher/steve/pkg/ext/testapis/v1.TestTypeOther":     schema_pkg_ext_testapis_v1_TestTypeOther(ref),
		"github.com/rancher/steve/pkg/ext/testapis/v1.TestTypeOtherList": schema_pkg_ext_testapis_v1_TestTypeOtherList(ref),
...
func schema_pkg_ext_testapis_v1_TestType(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_ext_testapis_v1_TestTypeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/rancher/steve/pkg/ext/testapis/v1.TestType"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/rancher/steve/pkg/ext/testapis/v1.TestType", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_ext_testapis_v1_TestTypeOther(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_ext_testapis_v1_TestTypeOtherList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TestTypeOtherList is a list of TestTypeOther resources",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/rancher/steve/pkg/ext/testapis/v1.TestTypeOther"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/rancher/steve/pkg/ext/testapis/v1.TestTypeOther", v1.ListMeta{}.OpenAPIModelName()},
	}
}
