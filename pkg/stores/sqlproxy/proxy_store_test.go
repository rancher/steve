...
//go:generate go tool -modfile ../../../gotools/mockgen/go.mod mockgen --build_flags=--mod=mod -package sqlproxy -destination ./proxy_mocks_test.go github.com/rancher/steve/pkg/stores/sqlproxy Cache,CacheFactory,SchemaColumnSetter,RelationshipNotifier,TransformBuilder,SchemaCollection
//go:generate go tool -modfile ../../../gotools/mockgen/go.mod mockgen --build_flags=--mod=mod -package sqlproxy -destination ./client_mocks_test.go github.com/rancher/steve/pkg/client ClientGetter
