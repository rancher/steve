...
func (s *SummaryCache) SummaryAndRelationship(obj runtime.Object) (*summary.SummarizedObject, []Relationship) {
	...
	if schema != nil {
		if attributes.HasObservedGeneration(schema) {
			hasObservedGeneration = true
		}
	}

	summarized := summary.Summarized(obj, hasObservedGeneration)
...
func addObject(rel Relationship, obj interface{}, schemas *schema.Collection) Relationship {
	...
	summarized := summary.Summarized(ro, hasObservedGeneration)
...
func (s *SummaryCache) process(obj runtime.Object) (*summary.SummarizedObject, []*summary.Relationship) {
	...
	var (
		...
		summary = summary.Summarized(obj, hasObservedGeneration)
	)
