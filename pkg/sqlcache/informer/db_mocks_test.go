...
// Source: github.com/rancher/steve/pkg/sqlcache/db (interfaces: TXClient,Rows,Client)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package informer -destination ./db_mocks_test.go github.com/rancher/steve/pkg/sqlcache/db TXClient,Rows,Client
//
...
func (m *MockClient) BeginTx(arg0 context.Context, arg1 bool) (db.TXClient, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) Upsert(arg0 db.TXClient, arg1 *sql.Stmt, arg2 string, arg3 any, arg4 bool) error {
	m.ctrl.T.Helper()
