...
//go:generate mockgen --build_flags=--mod=mod -package factory -destination ./transaction_mocks_tests.go github.com/rancher/steve/pkg/sqlcache/db/transaction TXClient
