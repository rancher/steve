...
// Source: github.com/rancher/steve/pkg/sqlcache/db/transaction (interfaces: Stmt,TxClient)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package informer -destination ./transaction_mocks_test.go -mock_names TxClient=MockTXClient github.com/rancher/steve/pkg/sqlcache/db/transaction Stmt,TxClient
//
