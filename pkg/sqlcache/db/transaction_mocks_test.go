...
// Source: github.com/rancher/steve/pkg/sqlcache/db/transaction (interfaces: TxClient,Stmt)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package db -destination ./transaction_mocks_test.go github.com/rancher/steve/pkg/sqlcache/db/transaction TxClient,Stmt
//
...
func (m *MockClient) Stmt(stmt *sql.Stmt) Stmt {
	m.ctrl.T.Helper()
